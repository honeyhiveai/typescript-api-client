...
export interface BatchCreateDatapointsRequest {
  /** @deprecated */
  events?: string[];
  /** @deprecated */
...
export interface AddDatapointsRequest {
...
export interface RemoveDatapointRequest {
...
export interface GetRunsSchemaRequest {
  /** @description Filter by date range */
...
export interface GetRunSchemaRequest {
...
export interface GetExperimentRunMetricsRequest {
  /** @description Experiment run ID (UUIDv4) */
  run_id: string;
...
export interface GetExperimentCompareEventsRequest {
 ...
 */
export type CreateEventBatchResponse = {
  event_ids: string[];
  session_id?: string;
  success: boolean;
};
 ...
 */
export type GetRunsSchemaResponse = {
 ...
 * @description Response for GET /events/schema, GET /runs/{run_id}/schema, and GET /runs/schema
 */
export type GetRunSchemaResponse = {
  fields: ExperimentSchemaField[];
  datasets: string[];
  mappings: {
    [key: string]: ExperimentSchemaMappingEntry[];
